            ...
            if (yes == 1)
            {
                ...
                for (int i = 0; i < 5; i++)
                {
                    for (int j = 0; j < 5; j++)
                    {
                        ...
                        {
                            colors[j] = Color.LightGoldenrodYellow;
                            break;
                        }
                    }
                }
